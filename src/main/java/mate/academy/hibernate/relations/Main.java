...
public class Main {
    public static void main(String[] args) {
        ...
        ActorService actorService = new ActorServiceImpl(new CountryDaoImpl(sessionFactory));
        actorService.add(vinDiesel);

        Movie fastAndFurious = new Movie("Fast and Furious");
        fastAndFurious.setActors(List.of(vinDiesel));
        MovieService movieService = new MovieServiceImpl(new CountryDaoImpl(sessionFactory));
