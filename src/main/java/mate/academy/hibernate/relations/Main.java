...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CountryService countryService = (CountryService) injector.getInstance(CountryService.class);
        countryService.add(usa);

        Actor vinDiesel = new Actor("Vin Diesel");
        vinDiesel.setCountry(usa);
        ActorService actorService = (ActorService) injector.getInstance(ActorService.class);
