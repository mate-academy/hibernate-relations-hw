...
public class Main {
    public static void main(String[] args) {
        ...
        ActorService actorService = new ActorServiceImpl(actor); // TODO: initialize this instance
        actorService.add(vinDiesel);

        Movie fastAndFurious = new Movie("Fast and Furious");
        fastAndFurious.setActors(List.of(vinDiesel));
        MovieDao movie = new MovieDaoImpl(sessionFactory);
        MovieService movieService = new MovieServiceImpl(movie); // TODO: initialize this instance
